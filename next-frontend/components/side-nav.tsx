...
import { SIDENAV_ITEMS_ADMIN } from '@/lib/constantsAdmin';
import { SIDENAV_ITEMS_SUPERVISOR } from '@/lib/constantsSupervisor';
                ...
                <div className="flex flex-col space-y-2  md:px-6 ">
                    {
                        ...
                        : sessionStorage.getItem('userType') == 'supervisor'
                            ?   SIDENAV_ITEMS_SUPERVISOR.map((item, idx) => {
                                    return <MenuItem key={idx} item={item} />;
                                })
        ...
        <div className="">
            {item.submenu ? (
                <>
                    ...
                    {subMenuOpen && (
                        <div className="my-2 ml-12 text-xs flex flex-col space-y-4">
